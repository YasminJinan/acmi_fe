...
<section class="bg-white dark:bg-[#0a0a0b] py-24 px-6 md:px-10 transition-colors duration-500 overflow-hidden mb"
   x-data="{
        search: '',
        category: 'Semua',
    ...
    <div class="max-w-7xl mx-auto relative pt-16">
            ...
            <div class="mt-10 flex flex-col md:flex-row gap-4 justify-center">
                ...
                <div class="relative">
                    <select x-model="category" 
                            class="w-full md:w-auto px-8 py-4 rounded-2xl bg-gray-100 dark:bg-white/5 border-none focus:ring-2 focus:ring-orange-500 dark:text-white cursor-pointer appearance-none">
                        <option value="Semua">{{ __('messages.all_categories') }}</option>
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 dark:bg-white/5 mb-4 border border-transparent group-hover:border-orange-500/20 transition-all">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-gray-400 text-[10px] uppercase tracking-tighter">{{ __('product.ceo_label') }}: <span class="text-gray-500 dark:text-gray-300" x-text="product.ceo"></span></p>
                                    </div>
                                </div>
        ...
        {{-- Empty State --}}
        <div x-show="filteredProducts.length === 0" x-cloak class="relative z-10 text-center py-24" data-aos="fade-up">
            ...
            <h3 class="text-xl font-bold text-gray-900 dark:text-white">{{ __('messages.empty_state_title') }}</h3>
            <p class="text-gray-500 dark:text-gray-400 mt-2">{{ __('messages.empty_state_desc') }}</p>
        </div>
