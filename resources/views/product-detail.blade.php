...
@section('content')
    <div class="min-h-screen bg-[#0a0c14] text-white pt-28 pb-20 px-4 md:px-10 font-sans">
        <div class="max-w-7xl mx-auto">
            <a href="/products" class="flex items-center text-gray-400 hover:text-white mb-8 transition">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div class="lg:col-span-5 space-y-6">
                    <div>
                        <span
                            class="bg-orange-500/20 text-orange-400 px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest border border-orange-500/30">
                        ...
                        <p class="text-gray-400 text-lg mb-2">{{ $product->company_name }}</p>
                        <p class="text-sm text-gray-500 mb-6">CEO: <span
                                class="text-gray-300">{{ $product->ceo_name }}</span></p>
                    ...
                    <div class="bg-[#111420] border border-gray-800 rounded-3xl p-8 space-y-5">
                        ...
                        <div class="space-y-4">
                            <a href="{{ $product->website }}"
                                class="flex items-center text-gray-400 hover:text-orange-400 transition">
                    ...
                    <div class="bg-[#111420] border border-gray-800 rounded-3xl p-8">
                        ...
                        <form class="space-y-4">
                            <input type="text" placeholder="Nama Lengkap"
                                class="w-full bg-[#0a0c14] border border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:border-orange-500 transition">
                            <input type="email" placeholder="Email"
                                class="w-full bg-[#0a0c14] border border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:border-orange-500 transition">
                            <input type="tel" placeholder="Nomor Telepon"
                                class="w-full bg-[#0a0c14] border border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:border-orange-500 transition">
                            <textarea rows="4" placeholder="Pesan Anda..."
                                class="w-full bg-[#0a0c14] border border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:border-orange-500 transition"></textarea>

                            <button
                                class="w-full bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 text-[#0a0c14] font-bold py-4 rounded-xl flex items-center justify-center space-x-2 transition transform active:scale-95 shadow-lg shadow-orange-500/20">
