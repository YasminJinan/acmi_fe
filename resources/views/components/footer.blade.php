                ...
                <ul class="space-y-6">
                    <li class="flex items-start gap-4 group">
                        ...
                        <span class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            ...
                            Menara 165, Lantai 4 Unit B, Jl. TB Simatupang No.Kav. 1, Cilandak Tim., Pasar Minggu, Jakarta Selatan, 12560.
                        </span>
                    </li>
        ...
        <div class="pt-10 border-t border-gray-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
            <div class="space-y-1">
                ...
                <div class="flex gap-4 justify-center md:justify-start">
                    <a href="#" class="text-[9px] uppercase tracking-tighter text-gray-400 hover:text-orange-500 transition-colors font-semibold">Privacy Policy</a>
                    <a href="#" class="text-[9px] uppercase tracking-tighter text-gray-400 hover:text-orange-500 transition-colors font-semibold">Terms of Service</a>
                </div>
            </div>
