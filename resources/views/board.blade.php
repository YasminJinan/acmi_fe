...
{{-- CTA JOIN SECTION --}}
<section class="relative py-24 md:py-32 bg-white dark:bg-[#0a0a0b] overflow-hidden transition-colors duration-500">
    <div class="container mx-auto px-6 relative z-10">
        
        {{-- Main CTA Card --}}
        <div data-aos="zoom-in" class="relative rounded-[3rem] bg-gray-900 dark:bg-white/[0.03] overflow-hidden border border-white/10 shadow-2xl">
            
            {{-- Background Glows --}}
            <div class="absolute top-0 right-0 w-[400px] h-[400px] bg-orange-500/20 rounded-full blur-[120px] -z-0"></div>
            <div class="absolute bottom-0 left-0 w-[300px] h-[300px] bg-orange-600/10 rounded-full blur-[100px] -z-0"></div>

            <div class="relative z-10 px-8 py-16 md:py-24 flex flex-col items-center text-center">
                
                {{-- Icon Badge --}}
                <div class="w-20 h-20 rounded-2xl bg-orange-500 flex items-center justify-center text-[#0a0a0b] mb-10 shadow-xl shadow-orange-500/20 transform -rotate-3 group-hover:rotate-0 transition-transform duration-500">
                    <i class="fa-solid fa-paper-plane text-3xl"></i>
                </div>

                <h2 class="text-4xl md:text-6xl font-poppins font-bold text-white mb-8 leading-tight">
                    Siap Bergabung dengan <br>
                    <span class="font-serif italic text-orange-500">ACMI?</span>
                </h2>

                <p class="text-gray-400 text-lg md:text-xl font-poppins max-w-2xl mx-auto mb-12 leading-relaxed">
                    Jadilah bagian dari ekosistem eksklusif pemimpin bisnis Indonesia. Bersinergi, tumbuh, dan berkontribusi untuk ekonomi bangsa.
                </p>

                {{-- Action Buttons --}}
                <div class="flex flex-col sm:flex-row items-center gap-6">
                    <a href="/register" class="group relative px-10 py-5 bg-orange-500 text-[#0a0a0b] font-bold rounded-2xl overflow-hidden shadow-lg shadow-orange-500/30 transition-all hover:scale-105 active:scale-95">
                        <span class="relative z-10 flex items-center gap-2">
                            Ajukan Keanggotaan Anda
                            <i class="fa-solid fa-arrow-right transition-transform group-hover:translate-x-1"></i>
                        </span>
                    </a>
                    
                    <a href="/contact" class="px-10 py-5 bg-white/5 backdrop-blur-md border border-white/10 text-white font-bold rounded-2xl hover:bg-white/10 transition-all active:scale-95">
                        Hubungi Kami
                    </a>
                </div>
