...
{{-- CHALLENGE SECTION --}}
<!-- 1. Perubahan Background Section: 
     Light: dari bg-white ke bg-gray-100/50 agar kartu putih lebih 'pop out'
     Dark: tetap atau ke hitam yang lebih pekat [#050506]
-->
<section class="bg-gray-100/50 dark:bg-[#050506] px-6 md:px-10 py-24 transition-colors duration-500 overflow-hidden">
    <div class="max-w-7xl mx-auto flex flex-col gap-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <!-- 2. Perubahan pada Card:
                 Light: Background murni bg-white dan border lebih tegas (border-gray-200)
                 Dark: Background lebih terang dari dasar (bg-[#121214]) dan border putih tipis
            -->
            <div 
                data-aos="fade-up" 
            ...
            >
                ...
                <div class="absolute inset-0 bg-gradient-to-br from-orange-500/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>

                <div class="relative z-10">
                    {{-- Icon Box: Dibuat lebih kontras dengan warna kartu --}}
                    <div class="w-14 h-14 bg-gray-50 dark:bg-white/5 text-orange-500 rounded-2xl flex items-center justify-center text-xl mb-8 border border-gray-100 dark:border-white/5 group-hover:bg-orange-500 group-hover:text-white group-hover:shadow-lg group-hover:shadow-orange-500/40 transition-all duration-500">
                ...
                <div class="mt-6 flex justify-end opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-x-2 group-hover:translate-x-0">
...
<section class="bg-gray-50 dark:bg-[#050505] py-16 px-6 md:px-10 transition-colors duration-500 overflow-hidden"   x-data="{
        search: '',
        category: 'Semua',
...
>
    ...
    <div class="absolute inset-0 z-0">
        ...
        {{-- Gradasi diperhalus --}}
        <div class="absolute inset-0 bg-gradient-to-b from-slate-50/90 via-slate-50 to-slate-50/90 dark:from-[#0a0a0b]/95 dark:via-[#0a0a0b] dark:to-[#0a0a0b]/95"></div>
    </div>

    <div class="relative z-10 max-w-7xl mx-auto px-6">
        
        {{-- Floating Badges (Kiri) --}}
        <div class="absolute -left-4 top-24 bg-white dark:bg-gray-800/90 backdrop-blur-xl p-4 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white dark:border-white/10 z-20 hidden xl:flex items-center gap-4 animate-bounce-slow">
            <div class="w-10 h-10 bg-green-500/10 text-green-600 dark:text-green-400 rounded-xl flex items-center justify-center">
                <i class="fa-solid fa-chart-line text-sm"></i>
            </div>
            <div>
                <p class="text-[10px] text-gray-400 uppercase font-black tracking-widest leading-none mb-1">Exclusive Network</p>
                <p class="text-xs font-bold text-slate-900 dark:text-white leading-none">500+ CEO Members</p>
            </div>
        </div>

        {{-- Floating Badges (Kanan) --}}
        <div class="absolute -right-4 bottom-1/3 bg-white dark:bg-gray-800/90 backdrop-blur-xl p-4 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white dark:border-white/10 z-20 hidden xl:flex items-center gap-4 animate-bounce-slow" style="animation-delay: 1.5s">
            <div class="w-10 h-10 bg-orange-500/10 text-orange-600 dark:text-orange-400 rounded-xl flex items-center justify-center">
                <i class="fa-solid fa-crown text-sm"></i>
            </div>
            <div>
                <p class="text-[10px] text-gray-400 uppercase font-black tracking-widest leading-none mb-1">Priority Access</p>
        ...
        <div class="text-center mb-16">
            <div class="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-orange-200 dark:border-orange-500/20 bg-orange-50/50 dark:bg-white/5 text-orange-600 dark:text-orange-400 text-[10px] font-black uppercase mb-6 tracking-[0.2em] shadow-sm backdrop-blur-md">
            ...
            <h2 class="text-4xl md:text-6xl font-poppins leading-tight text-slate-900 dark:text-white tracking-tight">
                ...
                <span class="font-serif font-bold italic text-orange-500 drop-shadow-sm">{{ __('messages.testimonial_title_2') }} {{ __('messages.testimonial_title_3') }}</span>
            </h2>
        </div>
        ...
        <div class="relative">
            <div 
                class="grid grid-cols-1 md:grid-cols-3 gap-8 transition-all duration-1000 ease-in-out"
                :class="open ? 'max-h-[4000px] opacity-100' : 'max-h-[450px] overflow-hidden md:max-h-[480px]'"
            >
                @php
                    $testimonials = [
                        ['name' => 'Budi Santoso', 'role' => 'CEO, PT Maju Bersama', 'initial' => 'B', 'bg' => 'bg-gradient-to-br from-orange-500 to-orange-600', 'quote' => __('messages.testi_1_quote')],
                        ['name' => 'Sarah Wijaya', 'role' => 'Founder, TechVenture ID', 'initial' => 'S', 'bg' => 'bg-gradient-to-br from-orange-400 to-orange-500', 'quote' => __('messages.testi_2_quote')],
                        ['name' => 'Herman Tanaka', 'role' => 'Dirut, Global Logistics', 'initial' => 'H', 'bg' => 'bg-gradient-to-br from-orange-500 to-orange-600', 'quote' => __('messages.testi_3_quote')],
                        ['name' => 'Anita Rose', 'role' => 'CEO, Creative Agency', 'initial' => 'A', 'bg' => 'bg-gradient-to-br from-orange-400 to-orange-500', 'quote' => __('messages.testi_4_quote')],
                        ['name' => 'Dedi Kurnia', 'role' => 'Founder, Retail Group', 'initial' => 'D', 'bg' => 'bg-gradient-to-br from-orange-500 to-orange-600', 'quote' => __('messages.testi_5_quote')],
                        ['name' => 'Linda Wang', 'role' => 'Director, Finance Corp', 'initial' => 'L', 'bg' => 'bg-gradient-to-br from-orange-400 to-orange-500', 'quote' => __('messages.testi_6_quote')]
                    ];
                @endphp

                @foreach($testimonials as $testi)
                    <div class="group relative bg-white dark:bg-white/5 backdrop-blur-2xl border border-slate-200 dark:border-white/10 p-8 rounded-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.02)] dark:shadow-none hover:shadow-[0_20px_40px_rgba(255,107,0,0.1)] dark:hover:bg-white/[0.08] transition-all duration-500 flex flex-col justify-between min-h-[380px] hover:-translate-y-2 overflow-hidden">
                        
                        {{-- Decorative Glow (Hover) --}}
                        <div class="absolute -right-4 -top-4 w-24 h-24 bg-orange-500/10 dark:bg-orange-500/20 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        ...
                        <div>
                            ...
                            <p class="text-slate-700 dark:text-gray-300 font-poppins leading-relaxed text-sm md:text-base italic mb-8 relative z-10">
                                "{{ $testi['quote'] }}"
                            </p>
                        </div>

                        <div class="flex items-center gap-4 pt-6 border-t border-slate-100 dark:border-white/5 relative z-10">
                            <div class="w-12 h-12 {{ $testi['bg'] }} text-white rounded-2xl flex-shrink-0 flex items-center justify-center text-lg font-black shadow-lg transform group-hover:rotate-6 transition-transform">
                                {{ $testi['initial'] }}
                            </div>
                            <div class="min-w-0">
                                <h4 class="text-slate-900 dark:text-white font-bold font-poppins text-sm md:text-base tracking-tight">{{ $testi['name'] }}</h4>
                                <p class="text-orange-600 dark:text-orange-400 font-poppins text-[10px] font-black uppercase tracking-widest mt-0.5">{{ $testi['role'] }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="mt-12 text-center relative z-30">
            ...
            >
                ...
                <i class="fa-solid transition-transform duration-500 text-[10px]" :class="open ? 'fa-chevron-up rotate-180' : 'fa-chevron-down'"></i>
            </button>
        </div>
    </div>
...
<section class="relative py-24 px-6 overflow-hidden bg-[#fafafa] dark:bg-[#0a0a0b] transition-colors duration-500">
    ...
    {{-- Background Blur --}}
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-orange-500/10 blur-[140px] rounded-full"></div>
    ...
    <div class="relative z-10 max-w-5xl mx-auto">
        ...
        <div 
            ...
            class="relative rounded-[3rem] p-12 md:p-20 text-center 
                   bg-white dark:bg-white/[0.03]
                   border border-black/5 dark:border-white/[0.08]
                   shadow-[0_10px_60px_rgba(0,0,0,0.06)]
                   dark:shadow-[0_10px_80px_rgba(0,0,0,0.5)]
                   backdrop-blur-xl
        ...
        >
            ...
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full
                        bg-orange-50 dark:bg-white/[0.04]
                        border border-orange-100 dark:border-white/10
                        mb-8 transition-all duration-500 hover:scale-105">

                <span class="text-orange-400 text-[10px]">✦</span>

                <span class="text-orange-500 text-[10px] font-bold tracking-[0.2em] uppercase">
            ...
            <h2 class="text-4xl md:text-5xl leading-tight mb-6 font-poppins">
                ...
                <span class="block font-semibold 
                             ...
                             transition-all duration-700 hover:tracking-tight">
                    {{ __('messages.cta_title_1') }}
                </span>

                <span class="font-serif font-bold italic text-orange-500">
                    {{ __('messages.cta_title_2') }}
                </span>
            </h2>

            {{-- Description --}}
            <p class="text-gray-600 dark:text-gray-400/80
                      text-base md:text-lg
                      font-poppins
                      max-w-2xl mx-auto mb-12
                      leading-relaxed
                      transition-opacity duration-500 hover:opacity-100 px-4">
            ...
            <div class="relative group inline-block">
                ...
                {{-- Glow --}}
                <div class="absolute -inset-1 bg-orange-500 rounded-[2rem]
                            blur-xl opacity-20
                ...
                <a href="#"
                   class="relative flex items-center gap-4
                    ...
                    <span class="font-poppins tracking-wide">
                        {{ __('messages.cta_btn') }}
                    </span>
                    ...
                    <div class="relative w-5 h-5 overflow-hidden">
                        ...
                        <i class="fa-solid fa-arrow-right absolute inset-0
                                  transition-all duration-500
                        ...
                        <i class="fa-solid fa-arrow-right absolute inset-0
                                  -left-full transition-all duration-500
                                  group-hover:left-0
            ...
            {{-- Footer Note --}}
            <p class="mt-8 text-[10px] md:text-xs
                      font-poppins tracking-[0.2em] uppercase
